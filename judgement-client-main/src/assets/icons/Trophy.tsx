...
export default function Trophy({ size = 30, className }: TrophyIconProps) {
  return (
    <svg
      height={size}
      width={size}
    ...
    >
      ...
      <g id='SVGRepo_iconCarrier'>
        ...
        <defs>
          ...
          >
            <stop stopColor='#C07F00' /> <stop offset='1' stopColor='#DE9300' />
          </linearGradient>
          <linearGradient
            ...
            gradientUnits='userSpaceOnUse'
          >
            <stop stopColor='#DE9300' /> <stop offset='1' stopColor='#FFBC11' />
          </linearGradient>
          <linearGradient
